...
export default function LeaveApprovals({ leaveRequests }: { leaveRequests: any[] }) {

    const updateStatus = (id: number, status: string) => {
        router.patch(route('leave.status', id), { status }, {
            preserveScroll: true,
        });
    };
    ...
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Leave Approvals</h2>}>
            <Head title="Leave Approvals" />

            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-6 border-b border-gray-200 bg-gray-50/50">
                    <h3 className="text-lg font-bold text-gray-900">All Leave Requests</h3>
